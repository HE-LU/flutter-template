...
class ConfigProduction {
  ...
  // You can find this value in Firebase Console -> Authentication -> Sign-in method -> Google -> Web SDK configuration.
  static const webClientId = 'your_prod_web_client_id';
}
